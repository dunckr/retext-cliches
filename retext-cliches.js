...
function attacher(processor, options) {
  ...
  function transformer(tree, file) {
    search(tree, phrases, function(match, position, parent, phrase) {
      ...
      console.log('we are here..', pattern);
...
},{"array-differ":2,"nlcst-search":3,"nlcst-to-string":7,"no-cliches/lib/list":8,"object-keys":9,"quotation":11}],2:[function(require,module,exports){
'use strict';
